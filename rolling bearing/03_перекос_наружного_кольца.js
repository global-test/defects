...
function display() {
  ...
  for (i = 1; i <= 5; i++) ausp.harms[0].add(i * f_outer, 1, 1, 0);
  for (i = 1; i <= 5; i++) spen.harms[0].add(i * f_outer, 1, 1, 0);

  for (i = 1; i <= 2; i++) ausp.harms[1].add(2 * i * f_outer, 1, 3, 0);
  for (i = 1; i <= 2; i++) spen.harms[1].add(2 * i * f_outer, 1, 3, 0);
