...
Объекты спектров (далее - спектральные объекты) предназначены для взаимодействия со спектрами обрабатываемого сигнала: 
* ``ausp`` - автоспектр; 
...
# <a name="common_methods"></a>3.2.1 Общие методы спектральных объектов:
