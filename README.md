...
* <a name="set_harms_count"></a>``.set_harms_count(COUNT)`` - устанавливает количество наборов гармоник, исследуемых в рамках данного дефекта
* <a name="set_slopes_count"></a>``.set_slopes_count(COUNT)`` - устанавливает количество наборов наклонов, исследуемых в рамках данного дефекта
* <a name="set_humps_count"></a>``.set_humps_count(COUNT)`` - устанавливает количество наборов горбов, исследуемых в рамках данного дефекта
