...
## <a name="hamrs_methods"></a> Методы настройки массива ``harms[]``
...
## Методы извлечения результатов из ``harams[]``
...
## Методы настройки массива ``slopes[]``
...
## Методы извлечения результатов из ``slopes[]``
...
## Методы настройки массива ``humps[]``
...
## Методы извлечения результатов из ``humps[]``
