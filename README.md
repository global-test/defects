...
Каждый элемент массива ``slopes[]`` представляет собой объект для работы с набором наклонов, в ходе анализа возможна настройка произвольного количества наборов наклонов в с объекте спектра. Доступ к набору наклонов осуществляется следующим образом: ``ausp.harms[N]``, где ``N`` - индекс набора наклонов. 
...
# <a name="slopes_array"></a>7. Массив наборов наклонов спектральных объектов - ``slopes[]``
