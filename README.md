...
# <a name="harms"></a>5. Массив наборов гармоник спектральных объектов ``harms[]``
...
## <a name="add"></a>Метод добавления гармоники в набор ``harms[N].add(FREQ, WIDTH, COLOR_INDEX)``
