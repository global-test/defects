...
4. [Глобальные объекты](#global_objects)
    ...
    * [ausp, ausp_hf, spen и spen_hf](#spectrs) 
        ...
        * [Общие дочерние массивы спектральных объектов](#common_arrays)
            + [set_options](#set_options)
            + [set_filter](#set_filter)
5. [harms - массив наборов гармоник спектальных объектов](#harms_array)
...
6. [slopes - массив наборов наклонов спектальных объектов](#harms_array)
    * [Методы настройки slopes](#)
        + [add_slope](#add_slope)
    * [Методы извлечения данных из slopes](#)
        + [get_slope](#get_slope)
7. [humps - массив наборов наклонов спектальных объектов](#harms_array)
...
## <a name="signal"></a>4.1 Глобальные объект ``signal``
...
# <a name="spectrs"></a>4.2 Глобальные объекты спектров ``ausp``, ``ausp_hf``, ``spen`` и ``spen_hf``
...
# <a name="common_methods"></a>3.2.1 Общие методы объектов спектров:
...
## <a name="child_objects"></a>3.2.2 Общие дочерние объекты:
