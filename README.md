...
#### Пример: ``ausp.add(i*freq, 1, 0);`` // для автоспектра
...
#### Пример: ``spen.set_declay(-0.05);`` // для спектра огибающей
...
#### Пример: ``spen.add_slope(0, freq / 2, 0);`` // для спектра огибающей
...
#### Пример: ``spen.add_hump(5000, 10000, 0);`` // для спектра огибающей
