...
function display() {
  ...
  ausp.set_options(f_tk * 20, (f_tk * 20) / (f_cage / 4), 5, 25);
  spen.set_options(f_tk * 20, (f_tk * 20) / (f_cage / 4), 5, 75);
  ...
  for (i = 1; i <= 7; i++)
    ausp.harms[0].add_modulated(i * f_tk, 1, f_cage, 1, 2, 1, 0, 1, 1);
  ...
  // 9 - индекс цвета модулирущей
  for (i = 1; i <= 7; i++)
    spen.harms[0].add_modulated(i * f_tk, 1, f_cage, 1, 2, 1, 0, 1, 1);
