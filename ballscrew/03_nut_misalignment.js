...
function display()																			//функция отображения
{
    ...
    for(i = 1; i <= 7; i++)
    {
        ...
        ausp.harms.add(i * f_nut, 1, width, 0);													//добавление гармоник на автоспектр. первый параметр - частота, второй - вес, третий толщнина линии, четвертый - индек колорбокса, задающего цвет.
        spen.harms.add(i * f_nut, 1, width, 0);													
    }
}
